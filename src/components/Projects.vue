                ...
                <div class="flex flex-col gap-8">
                    <div class="rounded-lg p-8 flex flex-col items-center bg-[#F6F6F6] shadow-lg">
                        ...
                        <div class="mt-4 grid grid-cols-4 gap-4">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/laravel/laravel-original-wordmark.svg" class="h-10 w-10 hover:scale-125 duration-500">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vuejs/vuejs-original-wordmark.svg" class="h-10 w-10 hover:scale-125 duration-500">
                            <img src="https://raw.githubusercontent.com/innocenzi/awesome-inertiajs/master/assets/logo.svg?sanitize=true" class="h-10 w-10 hover:scale-125 duration-500">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg" class="h-10 w-10 hover:scale-125 duration-500">
                        </div>
                        <a target="_blank" href="https://github.com/tachiniarthur/patos-digitais" class="mt-6 text-white bg-gray-900 hover:bg-gray-800 font-semibold rounded-lg text-sm px-5 py-2.5 text-center flex items-center hover:scale-110 duration-500">
                            View Github
                    ...
                    <div class="rounded-lg p-8 flex flex-col items-center bg-[#F6F6F6] shadow-lg">
                        ...
                        <a target="_blank" href="https://github.com/tachiniarthur/o-patusco" class="mt-6 text-white bg-gray-900 hover:bg-gray-800 font-semibold rounded-lg text-sm px-5 py-2.5 text-center flex items-center hover:scale-110 duration-500">
                            View Github
                            <ArrowTopRightOnSquareIcon class="h-5 w-5 ml-2" aria-hidden="true" />
                        </a>
                    </div>
                    <div class="rounded-lg p-8 flex flex-col items-center bg-[#F6F6F6] shadow-lg">
                        ...
                        <div class="mt-4 grid grid-cols-4 gap-4">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vuejs/vuejs-original-wordmark.svg" class="h-10 w-10 hover:scale-125 duration-500">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/javascript/javascript-original.svg" class="h-10 w-10 hover:scale-125 duration-500">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/bootstrap/bootstrap-original-wordmark.svg" class="h-10 w-10 hover:scale-125 duration-500">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/sass/sass-original.svg" class="h-10 w-10 hover:scale-125 duration-500">
                        </div>
                        <a target="_blank" href="https://github.com/tachiniarthur/front-autostockmanager" class="mt-6 text-white bg-gray-900 hover:bg-gray-800 font-semibold rounded-lg text-sm px-5 py-2.5 text-center flex items-center hover:scale-110 duration-500">
                            View Github
                            <ArrowTopRightOnSquareIcon class="h-5 w-5 ml-2" aria-hidden="true" />
                        </a>
                    </div>
